    ...
    <main className="flex-1 bg-white flex flex-col">
      ...
      <section className="w-full bg-white pt-8 pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <h2 
            className="text-[#4a1c0d] text-6xl md:text-8xl uppercase tracking-normal m-0 leading-none"
            style={{ fontFamily: "var(--font-bebas)" }}
          >
            Popular Items
          </h2>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center text-center group cursor-pointer">
              ...
              <h3 
                className="text-[#4a1c0d] text-lg md:text-xl uppercase leading-none m-0 mb-1"
                style={{ fontFamily: "var(--font-bebas)" }}
              >
                FAMILY MEALS
              </h3>
