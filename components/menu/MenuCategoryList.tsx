...
export const menuData = [
  {
    ...
    items: [
      ...
      { name: "Saucy Chicken Paratha", price: "RS 670", image: "/SaucyLachParatha.png", serves: "Juicy chicken wrapped in a crispy paratha" },
    ]
  },
  {
    id: "la-carta-combos",
    ...
    items: [
      ...
      { name: "Twister Wrap Combo", price: "RS 760", image: "/TwisterCombo.png", serves: "Twister wrap with regular fries and drink" },
  ...
  },
  {
    ...
    items: [
      { name: "Duo Box Large", price: "RS 1990", image: "/DuoboxPic.png", serves: "Serves 3 persons" },
      { name: "Outlaw Zinger Meal", price: "RS 1190", image: "/Outlaw Burger.png", serves: "With regular fries and drink" },
      { name: "Abraham's Double Stack", price: "RS 890", image: "/Abraham's Double Stack.png", serves: "Two crispy fillets with double cheese" },
      { name: "Chicken n Chips", price: "RS 1420", image: "/BestSellersDeal.png", serves: "Generous portion of chicken and chips" },
    ]
  },
  {
    id: "snacks-beverages",
    ...
    items: [
      { name: "Crispy Wings", price: "RS 690", image: "/ChickenBucket.png", serves: "6 pieces of hot wings" },
    ]
  }
];
        ...
        <div className="flex overflow-x-auto no-scrollbar gap-2 items-center">
          {menuData.map((cat) => (
            <button
              ...
              className={`flex-shrink-0 px-6 py-2 rounded-full font-bold text-sm transition-all duration-300 uppercase tracking-widest ${
