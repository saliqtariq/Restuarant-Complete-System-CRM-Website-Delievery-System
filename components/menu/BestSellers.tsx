...
export default function BestSellers() {
  ...
  const handleIncrease = (item: (typeof bestSellers)[number], cartItem?: { quantity: number }) => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-0 md:gap-y-2">
          {bestSellers.map((item) => (
            ...
            }} className="flex flex-col items-center text-center group cursor-pointer -mt-2">
