...
import { Search, Bell, ChevronDown, ShoppingBag, Truck, CheckCheck, Loader2, Utensils, Calendar, FileText, ArrowRight, X } from "lucide-react";
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="relative w-full max-w-md" ref={searchRef}>
          ...
          <input
            ...
            className="block w-full py-2 pl-10 pr-9 text-sm text-gray-700 bg-gray-50 rounded-full border border-gray-200 focus:ring-2 focus:ring-red-400/20 focus:border-red-500 outline-none placeholder-gray-400 transition-all"
            placeholder="Search orders, customers, menu items, catering..."
          />
          {query && (
            <button
              ...
              <div className="max-h-96 overflow-y-auto">
                {loading ? (
                  ...
                  <div className="py-8 text-center text-gray-400 text-sm">
                    No matching orders, items, or catering queries found.
                  </div>
                ) : (
                  results.map((res) => (
                    <div
                  ...
                  notifications.map((n) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[10px] text-gray-400 mt-0.5 capitalize" suppressHydrationWarning>
